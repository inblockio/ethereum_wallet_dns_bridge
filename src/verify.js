...
function verifySingleRecord(txtRecord, domain, recordName, recordIndex, dnssecValidated) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log(`\n${'='.repeat(80)}`);
...
function verifyProof(domain, lookupKey, expectedWallet) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            try {
                ...
                try {
                    txtRecords = yield new Promise((resolve, reject) => {
            ...
            const walletRecords = txtRecords.flat().filter(record => (record.includes('wallet=') &&
            ...
            for (let i = 0; i < walletRecords.length; i++) {
                ...
                const result = yield verifySingleRecord(record, actualDomain, recordName, i + 1, dnssecValidated);
                results.push(result);
                if (result.success) {
                    overallSuccess = true;
